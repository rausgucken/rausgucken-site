 ...
 * Route: /sachsenheim/events/*.ics
 *
 * Only activates for .ics requests. All other /sachsenheim/events/* requests
...
export async function onRequest(context) {
  ...
  // /sachsenheim/events/some-event-slug.ics -> some-event-slug
  ...
  let events;
  try {
    const dataUrl = new URL('/data/sachsenheim/events-current.json', url.origin);
...
function buildICS(ev) {
  ...
  lines.push(
    `X-ALT-DESC;FMTTYPE=text/html:<a href="${site}/sachsenheim/events/${ev.slug}">` +
