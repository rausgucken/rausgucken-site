// src/pages/murr/feed.xml.ts
// Atom 1.0 feed for Murr events — app-backbone ready.
...
import eventsRaw from "../../../public/data/murr/events-current.json";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Murr | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Murr – täglich aktualisiert.</subtitle>
