// src/pages/loechgau/feed.xml.ts
// Atom 1.0 feed for Löchgau events — app-backbone ready.
...
import eventsRaw from "../../../public/data/loechgau/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "loechgau";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Löchgau | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Löchgau – täglich aktualisiert.</subtitle>
