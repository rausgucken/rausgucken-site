// src/pages/erdmannhausen/feed.xml.ts
// Atom 1.0 feed for Erdmannhausen events — app-backbone ready.
...
import eventsRaw from "../../../public/data/erdmannhausen/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "erdmannhausen";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Erdmannhausen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Erdmannhausen – täglich aktualisiert.</subtitle>
