// src/pages/gemmrigheim/feed.xml.ts
// Atom 1.0 feed for Gemmrigheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/gemmrigheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "gemmrigheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Gemmrigheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Gemmrigheim – täglich aktualisiert.</subtitle>
