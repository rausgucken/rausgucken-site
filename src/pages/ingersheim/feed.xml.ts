// src/pages/ingersheim/feed.xml.ts
// Atom 1.0 feed for Ingersheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/ingersheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "ingersheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Ingersheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Ingersheim – täglich aktualisiert.</subtitle>
