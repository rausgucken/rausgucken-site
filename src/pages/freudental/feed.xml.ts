// src/pages/freudental/feed.xml.ts
// Atom 1.0 feed for Freudental events — app-backbone ready.
...
import eventsRaw from "../../../public/data/freudental/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "freudental";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Freudental | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Freudental – täglich aktualisiert.</subtitle>
