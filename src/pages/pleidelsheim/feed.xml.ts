// src/pages/pleidelsheim/feed.xml.ts
// Atom 1.0 feed for Pleidelsheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/pleidelsheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "pleidelsheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Pleidelsheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Pleidelsheim – täglich aktualisiert.</subtitle>
