// src/pages/oberriexingen/feed.xml.ts
// Atom 1.0 feed for Oberriexingen events — app-backbone ready.
...
import eventsRaw from "../../../public/data/oberriexingen/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "oberriexingen";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Oberriexingen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Oberriexingen – täglich aktualisiert.</subtitle>
