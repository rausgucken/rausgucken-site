// src/pages/_FEED_TEMPLATE/feed.xml.ts
// TEMPLATE — copy to src/pages/{city}/feed.xml.ts when adding a new city.
// Replace all tokens before use:
//   CITY_ID        → URL slug, e.g. kornwestheim
//   CITY_NAME_FULL → display name, e.g. Kornwestheim
//
// Atom 1.0 feed for city events.
...
import eventsRaw from "../../../public/data/CITY_ID/events-current.json";
...
<feed xmlns="http://www.w3.org/2005/Atom" xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in CITY_NAME_FULL | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in CITY_NAME_FULL – täglich aktualisiert.</subtitle>
