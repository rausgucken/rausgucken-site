// src/pages/hemmingen/feed.xml.ts
// Atom 1.0 feed for Hemmingen events — app-backbone ready.
...
import eventsRaw from "../../../public/data/hemmingen/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "hemmingen";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Hemmingen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Hemmingen – täglich aktualisiert.</subtitle>
