// src/pages/hessigheim/feed.xml.ts
// Atom 1.0 feed for Hessigheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/hessigheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "hessigheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Hessigheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Hessigheim – täglich aktualisiert.</subtitle>
