// src/pages/korntal-muenchingen/feed.xml.ts
// Atom 1.0 feed for Korntal-Münchingen events — app-backbone ready.
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Korntal-Münchingen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Korntal-Münchingen – täglich aktualisiert.</subtitle>
