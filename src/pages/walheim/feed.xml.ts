// src/pages/walheim/feed.xml.ts
// Atom 1.0 feed for Walheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/walheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "walheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Walheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Walheim – täglich aktualisiert.</subtitle>
