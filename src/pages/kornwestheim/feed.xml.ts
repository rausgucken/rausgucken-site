// src/pages/kornwestheim/feed.xml.ts
import eventsRaw from "../../../public/data/kornwestheim/events-current.json";

const SITE = "https://www.rausgucken.de";
const FEED_URL = `${SITE}/kornwestheim/feed.xml`;
const CITY_URL = `${SITE}/kornwestheim/`;
...
export async function GET() {
  ...
  const entries = events.map(ev => {
    const url = `${SITE}/kornwestheim/events/${esc(ev.slug)}/`;
