...
// Atom 1.0 feed for Möglingen events — app-backbone ready.
...
import eventsRaw from "../../../public/data/moeglingen/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "moeglingen";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Möglingen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Möglingen – täglich aktualisiert.</subtitle>
