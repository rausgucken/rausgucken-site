// src/pages/eberdingen/feed.xml.ts
// Atom 1.0 feed for Eberdingen events — app-backbone ready.
...
import eventsRaw from "../../../public/data/eberdingen/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "eberdingen";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Eberdingen | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Eberdingen – täglich aktualisiert.</subtitle>
