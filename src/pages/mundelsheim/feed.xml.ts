// src/pages/mundelsheim/feed.xml.ts
// Atom 1.0 feed for Mundelsheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/mundelsheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "mundelsheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Mundelsheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Mundelsheim – täglich aktualisiert.</subtitle>
