// src/pages/oberstenfeld/feed.xml.ts
// Atom 1.0 feed for Oberstenfeld events — app-backbone ready.
...
import eventsRaw from "../../../public/data/oberstenfeld/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "oberstenfeld";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Oberstenfeld | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Oberstenfeld – täglich aktualisiert.</subtitle>
