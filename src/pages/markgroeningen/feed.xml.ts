// src/pages/markgroeningen/feed.xml.ts
import eventsRaw from "../../../public/data/markgroeningen/events-current.json";

const SITE = "https://www.rausgucken.de";
const FEED_URL = `${SITE}/markgroeningen/feed.xml`;
const CITY_URL = `${SITE}/markgroeningen/`;
...
export async function GET() {
  ...
  const entries = events.map(ev => {
    const url = `${SITE}/markgroeningen/events/${esc(ev.slug)}/`;
