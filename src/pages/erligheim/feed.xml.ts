// src/pages/erligheim/feed.xml.ts
// Atom 1.0 feed for Erligheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/erligheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "erligheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Erligheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Erligheim – täglich aktualisiert.</subtitle>
