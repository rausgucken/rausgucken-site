// src/pages/sersheim/feed.xml.ts
// Atom 1.0 feed for Sersheim events — app-backbone ready.
...
import eventsRaw from "../../../public/data/sersheim/events-current.json";

const SITE     = "https://www.rausgucken.de";
const CITY_ID  = "sersheim";
...
<feed xmlns="http://www.w3.org/2005/Atom"
      ...
      xml:lang="de-DE">
  <id>${FEED_URL}</id>
  <title>Veranstaltungen in Sersheim | rausgucken.de</title>
  <subtitle>Aktuelle Events, Workshops und Ausstellungen in Sersheim – täglich aktualisiert.</subtitle>
